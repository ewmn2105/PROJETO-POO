...
public class RomanceController {
	...
	class listener implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			ResultSet resultado = roDAO.Leitura();
			try {
				if (resultado.next()) {
	...
	class salvarListener implements MouseListener{
		...
		public void mouseClicked(MouseEvent e) {
			...
			GenerosVO romanceVO = new GenerosVO();
			romanceVO.setTitulo(titulo);
			romanceVO.setAutor(autor);
			romanceVO.setTexto(texto);
			GenerosBO romanBO = new GenerosBO();
			boolean inserido = romanBO.InserirRomance(romanceVO);
			if(inserido) {
