...
import br.com.projeto.model.dao.RomanceRDAO;
import br.com.projeto.view.TelaRAcaoView;
import br.com.projeto.view.TelaRomanceRView;
import br.com.projeto.view.AcaoView;

public class RomanceRController {
	private TelaRomanceRView view;
	private RomanceRDAO RomanDAO;

	public RomanceRController(TelaRomanceRView view, Connection conexao) {
		this.view = view;
		this.RomanDAO = new RomanceRDAO();
		// viewa = new AcaoView();
	...
	class listener implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			try {
				...
				ResultSet resultado = RomanDAO.Leitura1(conexao, titulo, autor);
				try {
					if (resultado.next()) {
